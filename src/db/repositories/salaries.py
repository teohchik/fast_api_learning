...
from src.db.models import Salary
from src.db.repositories.base import BaseRepository
from src.db.repositories.mappers.mappers import SalaryDataMapper


class SalariesRepository(BaseRepository):
    model = Salary
    mapper = SalaryDataMapper
    ...
    async def get_last_month_salaries(
    ...
    async def get_salaries_for_month(self, user_id: int, year: int, month: int, pagination=None):
